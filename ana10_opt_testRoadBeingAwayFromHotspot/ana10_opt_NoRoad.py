...
cwd = '/home/physics/estszj/research_project/ana10_opt_testRoadBeingAwayFromHotspot/'  # CHECK HERE
dir_home='/home/physics/estszj/research_project/'

subdir_sim='ana10_opt_testRoadBeingAwayFromHotspot/'  # CHECK HERE
filename_sim=f'df_sims{AREA_ROAD}.joblib'

subdir_road='study_area_ana10/road_patterns/'  # CHECK HERE
...
filename_save = f'NoRoad_area{AREA_ROAD}_surveyfreq{SURVEY_FREQ}_nsites{NSITES}' # CHECK HERE
